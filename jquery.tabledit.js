...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        // Create delete button.
                        if (settings.viewCertificateButton) {
                            viewCertificateButton = '<a role="button" target="_blank" data-href="certificate.php?id=" class="view-certificate ' + settings.buttons.viewCertificate.class + '" style="float: none;">' + settings.buttons.viewCertificate.html + '</a>';
                        }

                        var toolbar = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: left;">\n\
                                           <div class="' + settings.groupClass + '" style="float: none;">' + editButton + deleteButton + viewCertificateButton + '</div>\n\
                                           ' + saveButton + '\n\
                                           ' + confirmButton + '\n\
                                           ' + restoreButton + '\n\
                                       </div></div>';
        ...
        settings.onDraw();
        if (settings.viewCertificateButton) {
            $('.view-certificate').each(function() {
